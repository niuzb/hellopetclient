...
bool CharacterSelectLayer::init()
{
	...
	do {
		...
		CCSprite* pSprite = CCSprite::create("game.png");
		...
		manager->CreateUILayoutFromFile("UIplist/CharacterCreate.plist", this, "CharacterCreate");
		...
		UITextInputField* uiField = m_layout->FindChildObjectByName<UITextInputField>("NameInput");
