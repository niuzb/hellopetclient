...
void GemStonesFromLua::init()
{
	...
	checkEnchaseUILayer();
	GameConfigFromLuaManager::Get()->checkAnyLoadFile("Script/UILayer/enchaseExchangeUILayer.lua");
}

bool GemStonesFromLua::checkEnchaseUILayer()
{
	return GameConfigFromLuaManager::Get()->checkAnyLoadFile("Script/UILayer/enchaseUILayer.lua");
}
...
{
	if(GameConfigFromLuaManager::Get()->checkAnyLoadFile("Script/UILayer/enchaseExchangeUILayer.lua"))
	{
...
{
	OnlineNetworkManager::sShareInstance()->sendExchangeParameterReq(exchangeId,equipPos);
}
