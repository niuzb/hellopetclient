...
{
	SpriteElfManager::Get()->AttachElfToOneHero(elfId,UserData::Get()->getUserId());
}
...
void SpriteElfDataCenter::SendGetElfListMessage(unsigned int roleId,const char* name)
{
...
unsigned int SpriteElfDataCenter::GetHeroUserId()
{
