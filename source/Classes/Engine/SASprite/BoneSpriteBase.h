...
public: 
	...
	///
	virtual void SetAnim(int animId, int nloop, bool isLoop = true,BoneSpriteBase *listerner = 0);
	...
	virtual void SetColliderBoxShowOrNot(bool bShow);
	...
	* @param 
	*/
	virtual bool playBecomeRedEffect();
