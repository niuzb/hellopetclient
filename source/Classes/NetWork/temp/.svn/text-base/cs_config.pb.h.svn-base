...
class CSRangeInfo : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_start(::CSPoint* start);
  ...
  inline void set_allocated_end(::CSPoint* end);
...
class CSMonsterInfo : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_body_range(::CSRangeInfo* body_range);
  ...
  inline void set_allocated_birth(::CSRangeInfo* birth);
  ...
  inline void set_allocated_patrol(::CSMonsterInfo* patrol);
...
inline void CSRangeInfo::set_allocated_start(::CSPoint* start) {
  delete start_;
  start_ = start;
  if (start) {
    set_has_start();
...
inline void CSRangeInfo::set_allocated_end(::CSPoint* end) {
  delete end_;
  end_ = end;
  if (end) {
    set_has_end();
...
inline void CSMonsterInfo::set_allocated_body_range(::CSRangeInfo* body_range) {
  delete body_range_;
...
inline void CSMonsterInfo::set_allocated_birth(::CSRangeInfo* birth) {
  delete birth_;
  birth_ = birth;
  if (birth) {
    set_has_birth();
...
inline void CSMonsterInfo::set_allocated_patrol(::CSMonsterInfo* patrol) {
  delete patrol_;
  patrol_ = patrol;
  if (patrol) {
    set_has_patrol();
