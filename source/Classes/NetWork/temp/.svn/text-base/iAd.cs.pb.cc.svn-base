...
void protobuf_ShutdownFile_iAd_2ecs_2eproto() {
  ...
  delete ack_errcode_t::_default_errmsg_;
  ...
  delete broadcast_player_enter_map_t::_default_user_nick_;
...
void protobuf_AddDesc_iAd_2ecs_2eproto() {
  ...
  ack_errcode_t::_default_errmsg_ =
  ...
  broadcast_player_enter_map_t::_default_user_nick_ =
...
const cs_empty_msg_t& cs_empty_msg_t::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_iAd_2ecs_2eproto();
...
::std::string* ack_errcode_t::_default_errmsg_ = NULL;
#ifndef _MSC_VER
...
::std::string* broadcast_player_enter_map_t::_default_user_nick_ = NULL;
#ifndef _MSC_VER
