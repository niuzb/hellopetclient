...
function onReceivedExchangeRsp(error)
	if error == 0 then
		...
		GameApi:showMessage("兑换失败" .. error);
	end
end
...
function EnchaseExchangeLayer:init(parentNode)
	...
	--self.greenGemName =	self.enchaseExchangeUILayer:FindChildObjectByName("greenNameLable").__UILabel__;
	--self.blueGemName = self.enchaseExchangeUILayer:FindChildObjectByName("blueNameLable").__UILabel__;
	--self.purpleGemName =	self.enchaseExchangeUILayer:FindChildObjectByName("purpleNameLable").__UILabel__;
	--self.yellowGemName = self.enchaseExchangeUILayer:FindChildObjectByName("yellowNameLable").__UILabel__;
	--self.orangeGemName = self.enchaseExchangeUILayer:FindChildObjectByName("orangeNameLable").__UILabel__;
