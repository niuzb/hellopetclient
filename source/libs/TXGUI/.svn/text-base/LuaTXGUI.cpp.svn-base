...
static int tolua_TXGUI_UIPicture_setSprite(lua_State *tolua_S)
{
#ifndef TOLUA_TXGUI_RELEASE
	tolua_Error tolua_err;
	if(
...
static int tolua_TXGUI_UIScrollPage_addPages(lua_State *tolua_S)
{
	...
	{
		tolua_error(tolua_S,"#ferror in function 'TXGUI::UIScrollPage::addPages'",&tolua_err);
		return 0;
	}
#endif
	TXGUI::UIScrollPage *self = (TXGUI::UIScrollPage*) tolua_tousertype(tolua_S,1,0);
...
static int tolua_TXGUI_UIScrollPage_moveToPage(lua_State *tolua_S)
{
#ifndef TOLUA_TXGUI_RELEASE
	tolua_Error tolua_err;
	if(
	...
	tolua_beginmodule(tolua_S,NULL);
		...
		tolua_beginmodule(tolua_S,"TXGUI");
			...
			tolua_beginmodule(tolua_S,"UIPicture");
				...
				tolua_function(tolua_S,"setSprite",tolua_TXGUI_UIPicture_setSprite);
		...
		tolua_beginmodule(tolua_S,"TXGUI");
			...
			tolua_beginmodule(tolua_S,"UIScrollPage");
				...
				tolua_function(tolua_S,"moveToPage",tolua_TXGUI_UIScrollPage_moveToPage);
		...
		tolua_beginmodule(tolua_S,"TXGUI");
#ifdef __cplusplus
			tolua_cclass(tolua_S,"UIScrollLayer","TXGUI::UIScrollLayer","",tolua_collect_TXGUI__UIScrollLayer);
#else
			tolua_cclass(tolua_S,"UIScrollLayer","TXGUI::UIScrollLayer","",NULL);
#endif
